...
public class InquiryController extends SuperController{
	...
	public ModelAndView addInquiry(@ModelAttribute("initBoxs") SBox sBox) {
		...
		mav.setViewName("/help/getInquiryList"); //redirect:
		return mav;
	}
	...
	public ModelAndView login(HttpServletRequest request,
			@RequestParam(value = "custType", required = true) String custType,
	...
	public ModelAndView addInquiry(@ModelAttribute("initBoxs") SBox sBox) {
		...
		SBox resultBox = inquiryService.addInquiry(sBox);
		ModelAndView mav = new ModelAndView("redirect:/help/getInquiryList.do");
	...
	/** 1:1문의 등록(실제 DB ADD/ 리스트 
	 * <pre>
	 * Inquiry Controller Method
	 * </pre>
	 * @author JUNG MI KIM
	 * @since 2013. 9. 23.
	 * @version 1.0
	 * @param request
	 * @param custType : 법인,개인
	 * @return
	 */	
	/*@RequestMapping(value = "/help/getInquiryList.do", method = RequestMethod.POST)
	public ModelAndView getInquiryList(HttpServletRequest request,
		...
		mav.addObject("result", inquiryService.addInquiry(sBox);
