...
<body>
 ...
 <c:forEach var="result" items="${inquiryList}" varStatus="status">   
   <tr align="center" bgColor="#cccccc">
	   <td width="10%" class="td"><c:out value="${result.CTN_ID}"/></td>
	   <td width="15" class="td"><a href="${HOME}/help/getNoticeDetail.do?ctnId=${result.CTN_ID}"><c:out value="${result.TL_NM}"/></a></td>
	   <td width="35%" class="td"><c:out value="${result.RMK_TXT}"/></td>
	   <td width="15%" class="td"><c:out value="${result.RMK_TXT}"/></td>
